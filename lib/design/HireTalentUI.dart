...
class HireTalentUI extends StatefulWidget{

  @override
  _HireTalentUiState createState() => new _HireTalentUiState();
}

class _HireTalentUiState extends State<HireTalentUI>{
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: new AppBar(
        ...
        leading: IconButton(
            onPressed: () => backPage(), icon: Icon(Icons.arrow_back), color: Colors.grey),
        actions: <Widget>[
          IconButton(
            onPressed: () {},
