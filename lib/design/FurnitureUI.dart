...
class FurnitureUI extends StatefulWidget{
  ...
  @override
  _FurnitureUiState createState() => new _FurnitureUiState();
}

class _FurnitureUiState extends State<FurnitureUI> with SingleTickerProviderStateMixin{
                        ...
                        child: Column(
                          children: <Widget>[
                            Container(
                              ...
                              decoration: BoxDecoration(
                                  image: DecorationImage(
                                      image: AssetImage('assets/image/sofas.png'))),
                            ),
                            Text(
                              'Sofas',
                          ...
                          children: <Widget>[
                            Container(
                              ...
                              decoration: BoxDecoration(
                                  image: DecorationImage(
                                      image:
                                      AssetImage('assets/image/wardrobe.png'))),
                            ),
                            Text(
                              'Wardrobe',
                              style: TextStyle(fontFamily: 'Quicksand'),
                        ...
                        child: Column(
                          children: <Widget>[
                            Container(
                              ...
                              decoration: BoxDecoration(
                                  image: DecorationImage(
                                      image: AssetImage('assets/image/desks.png'))),
                            ),
                            Text(
                              'Desk',
                              style: TextStyle(fontFamily: 'Quicksand'),
                          ...
                          children: <Widget>[
                            Container(
                              ...
                              decoration: BoxDecoration(
                                  image: DecorationImage(
                                      image:
                                      AssetImage('assets/image/dressers.png'))),
                            ),
                            Text(
                              'Dresser',
                              style: TextStyle(fontFamily: 'Quicksand'),
